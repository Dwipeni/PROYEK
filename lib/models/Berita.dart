...
List<Berita> demoProducts = [
  Berita(
    ...
    description: "Vaksinasi COVID-19 di Desa Tanggul Kundung diikuti oleh sebagian besar penduduk desa.",
    rating: 4.8,
    isFavourite: true,
    isPopular: true,
  ),
  Berita(
    ...
    description: "Kebakaran terjadi pada salah satu rumah warga. Pemicunya diduga adalah konsleting listrik.",
    rating: 4.1,
    isPopular: true,
  ),
  Berita(
    ...
    description: "Desa Tanggul Kundung bermaksud ingin mengembangkan wawasan masyarakat desa.",
    rating: 4.1,
    isFavourite: true,
    isPopular: true,
  ),
